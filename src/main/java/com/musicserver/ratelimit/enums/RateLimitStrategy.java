...
public enum RateLimitStrategy {
    ...
    public long getDefaultPeriod() {
        return switch (this) {
            case SLIDING_WINDOW, FIXED_WINDOW -> 60; // 1分钟
            case TOKEN_BUCKET, DISTRIBUTED_TOKEN_BUCKET -> 1; // 1秒
            case LEAKY_BUCKET -> 1; // 1秒
            case COUNTER -> 60; // 1分钟
            case WEIGHTED_ROUND_ROBIN -> 10; // 10秒
            case ADAPTIVE -> 30; // 30秒
            case HOTSPOT -> 10; // 10秒
            default -> 60; // 默认1分钟
        };
    }
    ...
    public long getDefaultLimit() {
        return switch (this) {
            case SLIDING_WINDOW, FIXED_WINDOW -> 100; // 1分钟100次
            case TOKEN_BUCKET, DISTRIBUTED_TOKEN_BUCKET -> 10; // 1秒10次
            case LEAKY_BUCKET -> 5; // 1秒5次
            case COUNTER -> 1000; // 1分钟1000次
            case WEIGHTED_ROUND_ROBIN -> 50; // 10秒50次
            case ADAPTIVE -> 200; // 30秒200次
            case HOTSPOT -> 20; // 10秒20次
            default -> 100; // 默认100次
        };
    }
